...
const sendMsg = ()=>{
  massages.value.push(msg.value.replace(/\r?\n|\r/g, '<br>'))
  msg.value=''
          ...
          <div class="w-2/3 border flex flex-col">
            ...
            <div class="flex-1 overflow-auto" style="background-color: #dad3cc" id="messageBox">
              <div class="py-2 px-3">
                ...
                <div class="flex justify-end mb-2"   v-for="massage,index in massages" :key="index">
                  <div class="rounded py-2 px-3"  style="background-color: #e2f7cb">
                    <p class="text-sm mt-1" v-html="massage"></p>
                    <p class="text-right text-xs text-grey-dark mt-1">12:45 pm</p>
                  </div>
                </div>
            ...
            <div class="bg-grey-lighter px-4 py-4 flex items-center">
              ...
              <div class="flex mx-4 justify-between w-full">
                <textarea class="w-full border rounded px-2 py-2" type="text" @keyup.enter.exact="sendMsg()" v-model="msg"  >
                  </textarea>
                <button  class="ml-2 bg-blue-500 hover:bg-blue-700 text-white font-bold py-2 px-4 rounded" @click='sendMsg()'>Send</button>
              </div>
              <div>
                <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24">
